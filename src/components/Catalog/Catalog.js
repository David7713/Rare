    ...
    return (
        <div className="grid-container">
            <div className="catalog-image1">
                <img src={CatalogImage1} alt='Omega-Watch'></img>
                <div className="text-overlay"> <div className='catalog-info'>
                    ...
                    <Link to={"/shop"} > <button className='watch-button'>SHOP NOW</button> </Link>
                </div></div>
            </div>
            <div className="catalog-image2"><img src={CatalogImage2} alt='Patek Phillippe-Watch'></img>
            ...
            <div className="catalog-image3"><img src={CatalogImage3} alt='Audemers Piguet-Watch'></img>
                <div className="text-overlay"> <div className='catalog-info'>
            ...
            <div className="catalog-image4"><img src={CatalogImage4} alt='Cartier-Watch'></img>
                <div className="text-overlay"> <div className='catalog-info'>
            ...
            <div className="catalog-image5"><img src={CatalogImage5} alt='Seiko-Watch'></img>
                <div className="text-overlay"> <div className='catalog-info'>
            ...
            <div className="catalog-image6"><img src={CatalogImage6} alt='Hublot-Watch'></img>
                <div className="text-overlay"> <div className='catalog-info'>
