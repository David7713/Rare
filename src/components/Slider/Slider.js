    ...
    <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
      ...
      <SwiperSlide>
        ...
        <div className='text-container'>
          ...
          <ul>
            ...
            <li className='watchPrice'>$750.00</li>
          </ul>
          <Link to={"/shop"} > <div className="buyButton">Buy Now</div>  </Link> 
        </div>
        <img src={slider1}></img>
      </SwiperSlide>
      ...
      <SwiperSlide>
        <div className='text-container2'>
          ...
          <ul>
            <li className='watchDescription'>Starting @</li>
            <li className='watchPrice'>$850.00</li>
          </ul>
          <Link to={"/shop"} > <div className="buyButton">Buy Now</div>  </Link> 
        </div>
        <img src={slider2}></img>
      ...
      <SwiperSlide>
        <div className='text-container3'>
          ...
          <ul>
            <li className='watchDescription'>Starting @</li>
            <li className='watchPrice'>$900.00</li>
          </ul>
          <Link to={"/shop"} > <div className="buyButton">Buy Now</div>  </Link> 
        </div>
        <img src={slider3}></img>
