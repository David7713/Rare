  ...
  return (
    <div>
      ...
      <div className='about-part'>
        ...
        <img className='about-image' src={AboutImage} alt='about-main-image'></img>
      ...
      <div className='watch-style-part'>
        ...
        <img className='watch-style-image' src={WatchStyleImage} alt='modern-watch-image'></img>
      </div>
      ...
      <div className='hand-made-part'>
        <img className='hand-made-image' src={HandMadeImage} alt='hand-maden-watch-image'></img>
